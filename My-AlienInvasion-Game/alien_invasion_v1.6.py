...
from bullets import Thunderbolt, Firebird
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONUP:
                    ...
                    if self.single_player_button.rect.collidepoint(mouse_x, mouse_y):
                        ...
                        single_player_game = SingleplayerAlienInvasion()
                ...
                if event.type == pygame.MOUSEBUTTONUP:
                    ...
                    if self.multiplayer_button.rect.collidepoint(mouse_x, mouse_y):
                        ...
                        multiplayer_game = MultiplayerAlienInvasion()
...
class MultiplayerAlienInvasion:
    ...
    def __init__(self):
        ...
        self.first_player_ship = Thunderbird(self, 0, 0)
        self.stats = GameStats(self)
        self.first_player_bullets = pygame.sprite.Group()
        self.second_player_ship = Phoenix(self, 0, 0)
    ...
    def run_game(self):
        ...
        while running:
            ...
            if self.stats.game_active:
                ...
                self.check_power_ups_collisions()
    ...
    def check_power_ups_collisions(self):
        ...
        if second_player_collision:
            self.second_player_ship.power_up()
...
class SingleplayerAlienInvasion(MultiplayerAlienInvasion):
