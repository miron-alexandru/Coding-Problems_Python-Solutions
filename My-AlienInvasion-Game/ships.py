...
class Thunderbird(Sprite):
	...
	def power_up(self):
		...
		if power_up_choice == 1:
			self.settings.first_player_bullet_speed += 0.5
		elif power_up_choice == 2:
			self.settings.first_player_bullet_width += 2
		elif power_up_choice == 3:
			self.settings.first_player_ship_speed += 0.5
...
class Phoenix(Thunderbird):
	...
	def power_up(self):
		power_up_choice = random.randint(1, 4)
		if power_up_choice == 1:
			self.settings.second_player_bullet_speed += 0.5
		elif power_up_choice == 2:
			self.settings.second_player_bullet_width += 2
		elif power_up_choice == 3:
			self.settings.second_player_ship_speed += 0.5
